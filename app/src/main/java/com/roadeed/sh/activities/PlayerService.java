...
public class PlayerService extends Service implements View.OnClickListener{
    ...
    private void updateRepeatTypeImage() {
        if(Constants.repeatType == 0){
            repeatTypeImg.setImageDrawable(getResources().getDrawable(R.drawable.ic_action_keyboard));
        }
        ...
        switch (v.getId()){
            ...
            case R.id.entire_width:
                ...
                if(WebPlayer.getPlayer().getMeasuredWidth() != scrnWidth) {
                    ...
                    entireWidthImg.setImageDrawable(getResources().getDrawable(R.drawable.ic_action_send_now));
                    isEntireWidth = true;
                }
                //Exit Entire Width
                else{
                    ...
                    viewToHide.updateViewLayout(WebPlayer.getPlayer(), playerEntireWidPar);
                    entireWidthImg.setImageDrawable(getResources().getDrawable(R.drawable.ic_action_keyboard));
                    isEntireWidth = false;
                }
                break;
...
//        Log.d("Head Size", String.valueOf(playerHeadImage.getHeight()));
    ...
    public static void setImageTitleAuthor(String vId) {
    }
}
