package com.roadeed.sh.cht.adapter;
...
import static com.roadeed.sh.R.id.img_chat;
...
public class ChatFirebaseAdapter extends FirebaseRecyclerAdapter<ChatModel,ChatFirebaseAdapter.MyChatViewHolder> {
    ...
    protected void populateViewHolder(MyChatViewHolder viewHolder, ChatModel model, int position) {
        ...
        if (model.getFile() != null){
            ...
            viewHolder.setIvChatPhoto(com.roadeed.sh.cht.util.Util.local(model.getMapModel().getLatitude(),model.getMapModel().getLongitude()));
    ...
    public class MyChatViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        MyChatViewHolder(View itemView) {
            ...
            ivChatPhoto = (ImageView)itemView.findViewById(img_chat);
