package com.roadeed.sh.databases;
...
public class DatabaseHandlerFavorite extends SQLiteOpenHelper {
    ...
    public void AddtoFavorite(Video pj) {
        ...
        values.put(KEY_CAT_ID, pj.getCat_id());
    ...
    public List<Video> getAllData() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                contact.setCategory_name(cursor.getString(2));
                contact.setVid(cursor.getString(3));
                contact.setVideo_title(cursor.getString(4));
                contact.setVideo_url(cursor.getString(5));
                contact.setVideo_id(cursor.getString(6));
                contact.setVideo_thumbnail(cursor.getString(7));
                contact.setVideo_duration(cursor.getString(8));
                contact.setVideo_description(cursor.getString(9));
                contact.setVideo_type(cursor.getString(10));
                contact.setTotal_views(cursor.getLong(11));
                contact.setDate_time(cursor.getString(12));
