 ...
 */
public class ColorChooserDialog1 extends Dialog{
    public ColorChooserDialog1(Context context) {
        super(context);
    }
    ...
    private void setListeners() {
        ...
        twentyOne.setTag(colors.get(17));
    ...
    public final int White =      0xff9E9E9E;
